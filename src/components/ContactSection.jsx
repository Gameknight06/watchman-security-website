...
export const ContactSection = () => {
    return (
        <section id={"contact"} className={"min-h-3/4 relative flex flex-col items-center justify-center px-4"}>
            <div className={"container mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-2 border-b-1 border-t-1 border-primary items-center justify-center"}>
                <div className={"gap-8 py-12 text-left flex flex-col justify-center m-2"}>
                    <h1 className={"text-3xl md:text-5xl font-bold -tracking-tight"}>
                        Contact Us
                    </h1>
                    <h4 className={"text-xs md:text-lg font-bold mt-6"}>
                        Need help with a technical issue?
                    </h4>
                    <h4 className={"text-xs md:text-lg font-bold"}>
